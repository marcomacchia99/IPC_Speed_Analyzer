...
int main(int argc, char *argv[])
{
    ...
    //write on log file
    fprintf(logfile, "p - received size of %dMB\n", size);
    fflush(logfile);
    ...
    mode = atoi(argv[2]);
    //write on log file
    fprintf(logfile, "p - received mode %d\n", mode);
    fflush(logfile);
    ...
    //write on log file
    fprintf(logfile, "p - received circular size of %dKB\n", circular_size);
    fflush(logfile);
    ...
    //write on log file
    fprintf(logfile, "p - open pipe for pid\n");
    fflush(logfile);
    ...
    //write on log file
    fprintf(logfile, "p - pid %d sent and open shared memory\n", pid);
    fflush(logfile);
    ...
    //write on log file
    fprintf(logfile, "p - shared memory truncated\n");
    fflush(logfile);
    ...
    //write on log file
    fprintf(logfile, "p - shared memory mapped\n");
    fflush(logfile);
    ...
    //write on log file
    fprintf(logfile, "p - semaphores opened\n");
    fflush(logfile);
    ...
    //write on log file
    fprintf(logfile, "p - semaphores initialized\n");
    fflush(logfile);
    ...
    //write on log file
    fprintf(logfile, "p - semaphores closed\n");
    fflush(logfile);
    ...
    //write on log file
    fprintf(logfile, "p - shared memory closed\n");
    fflush(logfile);
